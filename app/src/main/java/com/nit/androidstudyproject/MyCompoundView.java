...
public class MyCompoundView extends LinearLayout {
    ...
    public MyCompoundView(Context context, AttributeSet Attr) {
        super(context, Attr);
// To retrieve a LayoutInflater for inflating layout resources
      //  in this context.
...
// Using layout inflator
        LayoutInflater li =
                (LayoutInflater)getContext().getSystemService(service);
...
// Get references of the child controls
        ...
        eT = (EditText)findViewById(R.id.editText1); Btn = (Button)findViewById(R.id.add);
// Add functionality
        AddUrl();
